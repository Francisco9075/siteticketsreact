  ...
  import { X, ShoppingCart, ExternalLink, RefreshCw } from "lucide-react";
  ...
  export default function GerirBilhetes() {
    ...
    // Auto-refresh when component becomes visible (optional)
    useEffect(() => {
    ...
    function handleBuyTicket(bilhete: Bilhete) {
      if (!bilhete.payment_page_url) {
        alert("Link de pagamento não disponível para este bilhete");
        return;
      }
