        ...
        <Table>
          ...
          <TableHeader className="border-b border-gray-100 dark:border-white/[0.05]">
            <TableRow>
              ...
              <TableCell isHeader className="px-5 py-3 font-medium text-gray-500 text-start text-theme-xs dark:text-gray-400">Quantia_Disponivel</TableCell>
              <TableCell isHeader className="px-5 py-3 font-medium text-gray-500 text-start text-theme-xs dark:text-gray-400">Quantia_Vendida</TableCell>
              <TableCell isHeader className="px-5 py-3 font-medium text-gray-500 text-start text-theme-xs dark:text-gray-400">Preco</TableCell>
              ...
              <TableCell isHeader className="px-5 py-3 font-medium text-gray-500 text-start text-theme-xs dark:text-gray-400">ID_Evento</TableCell>
              <TableCell isHeader className="px-5 py-3 font-medium text-gray-500 text-start text-theme-xs dark:text-gray-400">ID_Estado_Bilhete</TableCell>
          ...
          <TableBody className="divide-y divide-gray-100 dark:divide-white/[0.05]">
            {tableData.map((order) => (
              <TableRow key={order.id}>
                ...
                {/* Colunas vazias fictícias para completar o exemplo */}
                <TableCell className="px-4 py-3 text-gray-400 text-theme-sm">--</TableCell>
                <TableCell className="px-4 py-3 text-gray-400 text-theme-sm">--</TableCell>
                <TableCell className="px-4 py-3 text-gray-400 text-theme-sm">--</TableCell>
                <TableCell className="px-4 py-3 text-gray-400 text-theme-sm">--</TableCell>
                ...
                <TableCell className="px-4 py-3 text-start">
                  <div className="flex gap-2">
                    ...
                    <button
                      ...
                      onClick={() => console.log("Excluir", order.id)}
                    >
                      Excluir
                    </button>
                  </div>
